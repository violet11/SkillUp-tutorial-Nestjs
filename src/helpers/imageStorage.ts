const FileType = import('file-type') // Using file-type from package.json, means that import is dynamic
import fs from 'fs'
import Logging from 'library/Logging'
import { diskStorage, Options } from 'multer' // Dependency for image upload
